...
"C:\Program Files\7-Zip\7z.exe" a -tzip apue-%ISODATE%.zip 3rdparty\cmake 3rdparty\3rdtest 3rdparty\*.bat apex boostpy cmake config pyext spam test Tutorial .\*.* -xr!spam\armadillo -xr!spam\ensmallen -xr!apex\modules\text -xr!spam\unittest\idata -xr!spam\unittest\rdata -xr!apex\modules\ximgproc -xr!apex\modules\hdf -xr!test\.vs -xr!__pycache__ -xr!reports