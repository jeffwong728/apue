...
"C:\Program Files\7-Zip\7z.exe" a -tzip apue.zip 3rdparty\cmake 3rdparty\*.bat apex boostpy cmake config pyext site_scons spam test Tutorial .\*.* -xr!spam\armadillo -xr!spam\ensmallen