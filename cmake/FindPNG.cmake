...
if(ZLIB_FOUND)
  find_path(PNG_PNG_INCLUDE_DIR png.h PATHS $ENV{VCPKG_DIR} PATH_SUFFIXES include NO_DEFAULT_PATH)
  ...
  if(NOT PNG_LIBRARY)
    find_library(PNG_LIBRARY_RELEASE NAMES ${PNG_NAMES} PATHS $ENV{VCPKG_DIR} PATH_SUFFIXES lib NO_DEFAULT_PATH)
    find_library(PNG_LIBRARY_DEBUG NAMES ${PNG_NAMES_DEBUG} PATHS $ENV{VCPKG_DIR}/debug PATH_SUFFIXES lib NO_DEFAULT_PATH)
  ...
  if (PNG_LIBRARY AND PNG_PNG_INCLUDE_DIR)
      ...
      set(_PNG_COMPILE_DEFINITIONS PNG_USE_DLL)
