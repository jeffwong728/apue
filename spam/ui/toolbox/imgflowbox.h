...
private:
    ...
    void OnFlowChartAdd(wxCommandEvent &cmd);
    void OnFlowChartRun(wxCommandEvent &cmd);
    void OnFlowChartAlign(wxCommandEvent &cmd);
    void OnFlowChartMode(wxCommandEvent &cmd);
