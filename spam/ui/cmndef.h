...
enum
{
    ...
    kSpamID_TOOLBOX_FLOWCHART_ADD,
    kSpamID_TOOLBOX_FLOWCHART_RUN,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_LEFT,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_RIGHT,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_TOP,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_BOTTOM,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_HCENTER,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_VCENTER,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_HDISTRIBUTE,
    kSpamID_TOOLBOX_FLOWCHART_ALIGN_VDISTRIBUTE,
    kSpamID_TOOLBOX_FLOWCHART_POINTER,
    kSpamID_TOOLBOX_FLOWCHART_CONNECT,

    kSpamID_STATION_THUMBNAIL_DELETE,
    kSpamID_STATION_THUMBNAIL_SAVE,

    kSpamID_GL_X_AXIS_ANGLE_SLIDER,
    kSpamID_GL_Y_AXIS_ANGLE_SLIDER,
    kSpamID_GL_Z_AXIS_ANGLE_SLIDER,

    kSpamID_GRAPHICS_VIEWPORT_HIDE,
    kSpamID_GRAPHICS_VIEWPORT_SHOW_ONLY,
    kSpamID_GRAPHICS_VIEWPORT_SHOW_ALL,
    kSpamID_GRAPHICS_VIEWPORT_HIDE_ALL,
...
extern const std::string cp_ToolProcPyramidLevel;
extern const std::string cp_ToolProcThresholdMin;
extern const std::string cp_ToolProcThresholdMax;
extern const std::string cp_ToolProcThresholdChannel;
extern const std::string cp_ToolProcFilterType;
extern const std::string cp_ToolProcFilterBorderType;
extern const std::string cp_ToolProcFilterBoxKernelWidth;
extern const std::string cp_ToolProcFilterBoxKernelHeight;
extern const std::string cp_ToolProcFilterGaussianKernelWidth;
extern const std::string cp_ToolProcFilterGaussianKernelHeight;
extern const std::string cp_ToolProcFilterGaussianSigmaX;
extern const std::string cp_ToolProcFilterGaussianSigmaY;
extern const std::string cp_ToolProcFilterMedianKernelWidth;
extern const std::string cp_ToolProcFilterMedianKernelHeight;
extern const std::string cp_ToolProcFilterBilateralDiameter;
extern const std::string cp_ToolProcFilterBilateralSigmaColor;
extern const std::string cp_ToolProcFilterBilateralSigmaSpace;
extern const std::string cp_ToolProcEdgeType;
extern const std::string cp_ToolProcEdgeChannel;
