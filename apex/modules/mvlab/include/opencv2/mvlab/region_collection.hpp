...
public:
    virtual int Draw(Mat &img, const std::vector<cv::Scalar> &colors, const float thickness = 1, const int style = 0) const = 0;
...
public:
    ...
    CV_WRAP virtual int Draw(InputOutputArray img, const std::vector<cv::Scalar> &colors, const float thickness = 1, const int style = 0) const = 0;
};
