...
namespace Miniball {
  ...
  struct CoordAccessor<Pit_, Cit_*> {
    typedef Pit_                                  Pit;      
    typedef Cit_*                                 Cit;
    inline  Cit operator() (Pit it) const { return &(it->x); }
  };

  // Class Declaration
  // =================

  template <int d, /*dimension*/ typename CoordAccessor>
  class Miniball {
  private:
    // types
    ...
    typedef typename std::list<Pit, MyAlloc<Pit>>::iterator     Sit;
  ...
  public:
    ...
    typedef typename std::list<Pit, MyAlloc<Pit>>::const_iterator SupportPointIterator;
    ...
    Miniball (Pit begin, Pit end, CoordAccessor ca = CoordAccessor());
  ...
  template <int d, typename CoordAccessor>
  Miniball<d, CoordAccessor>::~Miniball()
  {
  }

  template <int d, typename CoordAccessor>
  const typename Miniball<d, CoordAccessor>::NT* 
  Miniball<d, CoordAccessor>::center () const 
  {
    return current_c;
  }
  ...
  Miniball<d, CoordAccessor>::squared_radius () const 
  {
    return current_sqr_r;
  }

  template <int d, typename CoordAccessor>
  int Miniball<d, CoordAccessor>::nr_support_points () const 
  {
    assert (ssize < d+2);
    return ssize;
  } 
  ...
  template <int d, typename CoordAccessor>
  typename Miniball<d, CoordAccessor>::SupportPointIterator 
  Miniball<d, CoordAccessor>::support_points_begin () const 
  {
    return L.begin();
  }
  ...
  template <int d, typename CoordAccessor>
  typename Miniball<d, CoordAccessor>::SupportPointIterator 
  Miniball<d, CoordAccessor>::support_points_end () const  
  {
    return support_end;
  }
  ...
  template <int d, typename CoordAccessor>
  typename Miniball<d, CoordAccessor>::NT
  Miniball<d, CoordAccessor>::relative_error (NT& subopt) const 
  {
    NT e, max_e = nt0;
  ...
  template <int d, typename CoordAccessor>
  bool Miniball<d, CoordAccessor>::is_valid () const
  {
    NT suboptimality;
  ...
  template <int d, typename CoordAccessor>
  double Miniball<d, CoordAccessor>::get_time() const 
  {
    return time;
  }

  template <int d, typename CoordAccessor>
  void Miniball<d, CoordAccessor>::mtf_mb (Sit n)
  {
  ...
  template <int d, typename CoordAccessor>
  void Miniball<d, CoordAccessor>::mtf_move_to_front (Sit j) 
  {
    if (support_end == j)
      support_end++;
  ...
  template <int d, typename CoordAccessor>
  void Miniball<d, CoordAccessor>::pivot_mb (Pit n) 
  {
  ...
  template <int d, typename CoordAccessor>
  void Miniball<d, CoordAccessor>::pivot_move_to_front (Pit j) 
  {
    L.push_front(j);
  ...
  template <int d, typename CoordAccessor>
  inline typename Miniball<d, CoordAccessor>::NT 
  Miniball<d, CoordAccessor>::excess (Pit pit) const 
  {
    Cit p = coord_accessor(pit);
    NT e = -current_sqr_r;
    NT* c_local = current_c;
    for (int k=0; k<d; ++k){
      e += mb_sqr<NT>(*p++-*c_local++);
    }
    return e;
  ...
  template <int d, typename CoordAccessor>
  void Miniball<d, CoordAccessor>::pop ()  
  {
    --fsize;
  }

  template <int d, typename CoordAccessor>
  bool Miniball<d, CoordAccessor>::push (Pit pit) 
  {
    int i, j;
